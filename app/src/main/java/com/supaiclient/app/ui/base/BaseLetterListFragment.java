...
import com.supaiclient.app.widget.MyLetterListView;
 ...
 */
public abstract class BaseLetterListFragment<T extends BaseResponseBodyBean> extends BaseFragment
...
//                com.supaisend.app.util.T.s(message);
    ...
    protected int getLayoutId() {
        return R.layout.fragment_pull_refresh_letter_listview;
    }
...
//            baseListHeadDialog.startAnimation(createTranslationInAnimation());
     ...
     * 初始化 拼音
     */
    public void initPingying(List<PeopleBean> arrlist) {
        ...
        for (int i = 0; i < size; i++) {
            // 当前汉语拼音首字母
            String currentStr = arrlist.get(i).getFirst();
            ...
            String previewStr = "";
            if (i - 1 >= 0) {
                PeopleBean cb = arrlist.get(i - 1);
                previewStr = cb.getFirst();
